...
# Usage: ./Run_Command.sh <TrackerName> [test|train]
# Place and run this script inside the project root directory

# CUDA_VISIBLE_DEVICES=0 OMP_NUM_THREADS=1 bash Run_Command.sh HIPTrack train
